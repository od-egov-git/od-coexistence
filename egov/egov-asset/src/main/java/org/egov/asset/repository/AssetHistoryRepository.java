...
public interface AssetHistoryRepository extends JpaRepository<AssetHistory, Long>{
	...
	public List<AssetMaster> getAssetMasetrHisory(@Param("code") String code, @Param("name") String name, @Param("category") Long category, @Param("department") String department, @Param("status") Long status);
