...
function callAjaxSearch() {
	...
	reportdatatable = drillDowntableContainer
			.dataTable({
				...
				buttons :[
					{extend:'print',title: ""+heading1+"",filename: 'View Suppliers'},
					{extend:'excel',title: ""+heading1+"",filename: 'View Suppliers'},
					{ extend:'pdf',title: ""+heading1+"",filename: 'View Suppliers'}],
				aaSorting : [],
				columns : [ {
					"data" : "name",
					"sClass" : "text-left"
