...
jQuery('#btnsearch').click(function(e) {
	...
	function prepareHeading(){
		var heading= "Function Search Result ";
		/*if($("#type").val()){
	...
	var heading1 = prepareHeading();
		reportdatatable = drillDowntableContainer
			.dataTable({
				...
				buttons :[
					{extend:'print',title: ""+heading1+"",filename: 'View Functions'},
					{extend:'excel',title: ""+heading1+"",filename: 'View Functions'},
					{ extend:'pdf',title: ""+heading1+"",filename: 'View Functions'}],
				aaSorting: [],				
				columns : [ { 
