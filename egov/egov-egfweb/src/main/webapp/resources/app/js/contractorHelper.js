...
function prepareHeading(){
	var heading= "Contractor Search Result ";
		
	$("#contractorresult").html(heading);
...
function callAjaxSearch() {
	...
	reportdatatable = drillDowntableContainer
			.dataTable({
				...
				buttons :[
					{extend:'print',title: ""+heading1+"",filename: 'View Contractors'},
					{extend:'excel',title: ""+heading1+"",filename: 'View Contractors'},
					{ extend:'pdf',title: ""+heading1+"",filename: 'View Contractors'}],
				aaSorting : [],
				columns : [ {
					"data" : "name",
					"sClass" : "text-left"
