		...
		<s:push value="model">
			...
			<div class="formmainbox">
				<div class="subheadnew">
					<s:text name="lbl.create.direct.bank.payment" />
				</div>
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0">
					...
					<div align="left" class="mandatory1">
						*
						<s:text name="lbl.mendatory.fields" />
					</div>
				...
				<input type="hidden" id="commonBean.fundnew"
					name="commonBean.fundnew" value="${commonBean.fundnew}" /> <input
					type="hidden" id="commonBean.departmentnew"
					name="commonBean.departmentnew" value="${commonBean.departmentnew}" />
				<input type="hidden" id="commonBean.functionnew"
					name="commonBean.functionnew" value="${commonBean.functionnew}" />
