...
<body onload="onLoad();documentdep();">
 ...
 */
...

		{
			...
			var rtgs= document.getElementById("paymentMode").value;

			if(rtgs=="rtgs"||rtgs=="Rtgs"){
			...
			if(rtgs!=null){
				...
				submitUrl=submitUrl+'&paymentChequeNo='+paymentChequeNo;
