...
function getData(){
	...
	isValid = validateDataAssign();
	if(isValid == false)
		return false;
	var url = '/services/EGF/deduction/remitRecovery-ajaxLoadSummaryData.action?skipPrepare=true&asOnDate='+asOnDate+'&department.code='+
							department+'&fund.id='+fund+'&recoveryAssign.id='+recovery+'&fromDate='+fromDate;
...
<body >
	...
	<jsp:include page="remitRecovery-assignForm.jsp"></jsp:include>
</body>
</html>
