	...
	<s:form action="preApprovedVoucher" theme="simple"
		...
		<div class="formmainbox">
			...
			<div id="listid" style="display: block">
					...
					<div align="center">
						<table border="0" width="100%" cellspacing="0">
							<tr>
								...
								<td colspan="3" class="bluebox"><s:date name="voucherDate"
				...
				<jsp:include page="voucherViewEditHeader.jsp" />
				<s:hidden id="voucherDate" name="voucherDate" value="%(preApprovedVoucher.voucherDate)"/>
