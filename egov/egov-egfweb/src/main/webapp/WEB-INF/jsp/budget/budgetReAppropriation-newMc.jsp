...
<body>
	...
	<script>
			...
			function validate(checkUser,method){
				...
				document.budgetDetailForm.action='/services/EGF/budget/budgetReAppropriation-'+method+'Mc.action';
			...
			function loadActuals(event){
				...
				document.budgetDetailForm.action='/services/EGF/budget/budgetReAppropriation-loadActualsMc.action';
	    		document.budgetDetailForm.submit();
			}
		</script>
					...
					<span>
						...
						<table width="60%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<div align="center">
										<s:submit method="loadActualsMc" key="lbl.get.actuals"
							...
							<tr>
								<td colspan="9">
									<div class="subheadsmallnew">
										<strong><s:text
												name="budget.reappropriation.add.release.mc.verify" /></strong>
									</div>
								</td>
							</tr>
						</table>
							...
							<td>
								<div class="buttonbottom" style="padding-bottom: 10px;">
									<input type="submit" value="Approve"
										id="budgetReAppropriation__create" name="method:createMc"
