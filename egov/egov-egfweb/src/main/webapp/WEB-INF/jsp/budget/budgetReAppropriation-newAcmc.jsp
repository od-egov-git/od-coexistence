...
<body>
	...
	<script>
			...
			function validate(checkUser,method){
				...
				document.budgetDetailForm.action='/services/EGF/budget/budgetReAppropriation-'+method+'Acmc.action';
					...
					<span>
						...
						<table width="60%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<div align="center">
										<s:submit method="loadActualsAcmc" key="lbl.get.actuals"
						...
						<tr>
							<td>
								<div class="buttonbottom" style="padding-bottom: 10px;">
									<input type="submit" value="Forward to MC"
