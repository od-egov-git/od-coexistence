...
function generateReport(){
	...
	if(isValid == false)
		return false;
	doLoadingMask();
	var url = '../report/chequeIssueRegisterReport-onlineResults.action?fromDate='+fromDate+'&toDate='+toDate+'&accountNumber.id='+bankAccount+'&deptImpl.code='+department+'&bank='+bank+'&showDropDown=false';
...
<body>
	<div class="formmainbox">
		...
		<div class="subheadnew">Online Transaction Issue Register Report</div>
		<br/>
		<br/>
		...
		<s:form action="chequeIssueRegisterReport" theme="simple"
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td class="greybox" width="10%">Transaction From Date:<span
					...
					<td width="10%">&nbsp;</td>
					<td class="greybox" width="10%">Transaction To Date:<span
						class="mandatory1">*</span></td>
