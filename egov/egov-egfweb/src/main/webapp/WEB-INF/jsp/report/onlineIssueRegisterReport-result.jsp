				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<th class="bluebgheadtd" width="100%"><strong
							style="font-size: 15px;"> Online Transaction issue register report
							...
							<div>
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<th class="bluebgheadtd" width="2%">Transaction Number</th>
										<th class="bluebgheadtd" width="8%">Transaction Date</th>
