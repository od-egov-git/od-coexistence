...
<div class="row display-hide report-section">
  <div class="col-md-12 table-header text-left" id="purchaseorderresult"><spring:message code="purchaseorder.search.result" text="Purchase Order Search Result"/> </div>
