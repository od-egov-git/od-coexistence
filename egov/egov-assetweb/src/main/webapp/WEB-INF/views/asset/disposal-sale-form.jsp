...
<div class="panel-body">
	<div class="form-group">
		...
		<div class="col-sm-3 add-margin">
			<form:input path="asset.name" value="${asset.name}" readonly="true"/>
		</div>
		<label class="col-sm-3 control-label text-right">
			<spring:message code="lbl.asset.description" text="Asset Description" /> 
		</label>
		<div class="col-sm-3 add-margin">
			<form:input path="asset.description" value="${asset.description}" readonly="true"/>
		</div>
		<label class="col-sm-3 control-label text-right">
			<spring:message code="lbl.assetcategory.name" text="Asset Category Name" /> 
		</label>
		<div class="col-sm-3 add-margin">
			<form:input path="asset.assetCategory.name" value="${asset.assetCategory.name}" readonly="true"/>
		</div>
	...
	<div class="panel-body">
		...
		<div class="col-sm-3 add-margin">
			<form:input path="disDate" class="form-control datepicker" data-date-end-date="0d" placeholder="DD/MM/YYYY"/>
		</div>
