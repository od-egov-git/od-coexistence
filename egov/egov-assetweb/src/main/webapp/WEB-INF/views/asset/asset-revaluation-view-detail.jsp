			...
			<div class="panel-body">
				...
				<div class="col-sm-3 add-margin">
					<form:input class="form-control" required="required"
						readonly="true" path="rev_order_no" />
				</div>
				<label class="col-sm-3 control-label text-right"> <spring:message
				...
				<div class="col-sm-3 add-margin">
					<form:select path="type_of_change" readonly="true"
						onchange="changeValues();" id="type_of_change" required="required"
						class="form-control">
						<form:option value="">
				...
				<div class="col-sm-3 add-margin">
					<form:input id="add_del_amt" class="form-control text-left"
						readonly="true" required="required" onchange="changeValues();"
